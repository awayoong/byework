...
export default function Home() {
  return (
    <div>
      <section id="section1" className="flex flex-col items-center justify-center bg-blue-50 text-gray-800 shadow-md py-16">
      ...
      <section id="section2" className="bg-white text-gray-800 shadow-md py-16">
        ...
        <div>
          <h4 className="text-center text-3xl font-bold my-16">豊富な決済手段</h4>
      ...
      <section id="section3" className="bg-blue-50 text-gray-800 shadow-md py-16">
